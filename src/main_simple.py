...
for x in range(0,tam):
    cv2.line(img2, (0, ini_filas[x]), (colum, ini_filas[x]), 100, 5)
    cv2.line(img2, (0, fin_filas[x]), (colum, fin_filas[x]), 100, 5)
...
for x in range(0,tam):
    ...
    for y in range(0,tam_palabra):
        cv2.line(img2, (ini_palabra[y], ini_filas[x]), (ini_palabra[y], fin_filas[x]), 100, 3)
        cv2.line(img2, (fin_palabra[y], ini_filas[x]), (fin_palabra[y], fin_filas[x]), 100, 3)
